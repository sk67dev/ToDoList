...
import app.bluecoral.MinimaLista.DeleteModel.MyWeekendDeleteToDoActivity
import app.bluecoral.MinimaLista.R
import kotlinx.android.synthetic.main.todo_row.view.*

class MyWeekendAdapter(val todos: List<String>) : RecyclerView.Adapter<MyWeekendAdapter.ToDoHolder>() {
    ...
    class ToDoHolder(v: View) : RecyclerView.ViewHolder(v), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            val intent = Intent(view.context, MyWeekendDeleteToDoActivity::class.java)
