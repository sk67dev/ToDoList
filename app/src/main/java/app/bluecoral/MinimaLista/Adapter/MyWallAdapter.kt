...
import app.bluecoral.MinimaLista.DeleteModel.MyWallDeleteToDoActivity
import app.bluecoral.MinimaLista.R
import kotlinx.android.synthetic.main.todo_row.view.*

class MyWallAdapter(val todos: List<String>) : RecyclerView.Adapter<MyWallAdapter.ToDoHolder>() {
    ...
    class ToDoHolder(v: View) : RecyclerView.ViewHolder(v), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            val intent = Intent(view.context, MyWallDeleteToDoActivity::class.java)
