...
import app.bluecoral.MinimaLista.DeleteModel.MyDayDeleteToDoActivity
import app.bluecoral.MinimaLista.R
import kotlinx.android.synthetic.main.todo_row.view.*

class MyDayAdapter(val todos: List<String>) : RecyclerView.Adapter<MyDayAdapter.ToDoHolder>() {
    ...
    class ToDoHolder(v: View) : RecyclerView.ViewHolder(v), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            val intent = Intent(view.context, MyDayDeleteToDoActivity::class.java)
