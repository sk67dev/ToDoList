...
import app.bluecoral.MinimaLista.DeleteModel.CleanSheetDeleteToDoActivity
import app.bluecoral.MinimaLista.DeleteModel.HomeBillsDeleteToDoActivity
import app.bluecoral.MinimaLista.R
import kotlinx.android.synthetic.main.todo_row.view.*

class CleanSheetAdapter(val todos: List<String>) : RecyclerView.Adapter<CleanSheetAdapter.ToDoHolder>() {
    ...
    class ToDoHolder(v: View) : RecyclerView.ViewHolder(v), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            val intent = Intent(view.context, CleanSheetDeleteToDoActivity::class.java)
