...
import app.bluecoral.MinimaLista.CreateModel.MyDayToDoActivity
import app.bluecoral.MinimaLista.R
import kotlinx.android.synthetic.main.activity_my_day_todo.*
import kotlinx.android.synthetic.main.content_my_day.*

class MyDayActivity : AppCompatActivity() {

        lateinit var layoutManager: LinearLayoutManager
        lateinit var adapter: MyDayAdapter

        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            setContentView(R.layout.activity_my_day_todo)
            setSupportActionBar(toolbar)

            //Add intent to go to HomeBillsToDoActivity
            fab.setOnClickListener { view ->
                val intent = Intent(this, MyDayToDoActivity::class.java )
        ...
        fun updateRecycler() {
            ...
            adapter = MyDayAdapter(todos.toList())
