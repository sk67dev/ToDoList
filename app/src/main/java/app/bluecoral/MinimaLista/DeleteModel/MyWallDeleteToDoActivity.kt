...
class MyWallDeleteToDoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_delete_my_wall_todo)
        ...
        completeButton.setOnClickListener {
            ...
            prefs.edit().putStringSet(getString(R.string.TODO_STRINGS9), todos).apply()
