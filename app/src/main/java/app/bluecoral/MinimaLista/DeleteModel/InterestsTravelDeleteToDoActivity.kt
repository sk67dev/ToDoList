...
class InterestsTravelDeleteToDoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_delete_interests_travel_todo)
        ...
        completeButton.setOnClickListener {
            ...
            prefs.edit().putStringSet(getString(R.string.TODO_STRINGS5), todos).apply()
