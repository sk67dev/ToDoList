...
class CleanSheetDeleteToDoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_delete_clean_sheet_todo)
        ...
        completeButton.setOnClickListener {
            ...
            prefs.edit().putStringSet(getString(R.string.TODO_STRINGS10), todos).apply()
